...
u8l7_help1b = ConvoScreen:new {
  id = "help1b",
  leftDialog = "",
  customDialogText = "Let me put it this way, you're in a whole new world, starting on an adventure unlike any you have had before. Forget your previous experiences and enjoy this galaxy for what it is! Personally, Sir, I highly suggest that you take some time to read the manual, because there are fundimental things you will need to understand about WHY the galaxy is the way it is. Suffice to say that you are a member of a pirate gang and no matter the role you choose to play, your loyalties and experiences lie with your gang, in the spirit of the legendary priate, Hondo Onaka.",
  stopConversation = "false",
  options = {
	{"Are there other helpers like you?", "help1a"},
	{"How do I earn credits?", "help1c"},
