...
function LokNymStrongholdScreenPlay:spawnMobiles()
	...
	--trainer Replaced for Legend of Hondo
	spawnMobile("lok", "surgical_droid_21b",60,-17.1,0.26,9.2,-100,2745870)
	spawnMobile("lok", "scientist",60,22.1279,0.26,-6.11676,91,2745866)
	spawnMobile("lok", "medic",60,-16.0068,0.26,-2.42861,117,2745870)
